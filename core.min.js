/* core.js v0.2.6d by @carlosgavina | hello@carlosgavina.com | https://github.com/carlosgavina/corejs */
...
typeof b.ownerDocument}}},k={_:{},Apps:{},Tools:q,Object:function(b){var e=this,c=q.typeOf,a;a=document.createElement("p");var g={_:{_:$(a)}},h={},l=function(a,d,e){var f;d="string"===c(d)?d:"_";e="boolean"===c(e)?e:!0;if("string"===c(a)){f=a.split(":");1===f.length?(a="_",f=f[0]):(a=f[0],f=f[1]);if("object"!==c(g[a])&&!0===e)g[a]={};else if("object"!==c(g[a]))return;if("object"!==c(g[a][d])&&!0===e)g[a][d]=$(document.createElement("p"));else if("object"!==c(g[a][d]))return;return{context:d,name:f,
hub:g[a],event:g[a][d]}}};this._={};this._.clone=function(){Object.create||function(a){function d(){}d.prototype=a;return new d}};this._.implement=function(a){if(a)for(var d in a)a.hasOwnProperty(d)&&(e[d]=a[d]);return e};a=this._.clone(this);b&&this._.implement.call(a,b);this.on=function(a,d,b){d="function"===typeof d?d:void 0;a=l(a,b);if("object"===c(a)&&"function"===c(d))a.event.on(a.name,$.proxy(d,e));return e};this.trigger=function(a,d,b){var f="string"===c(b)?b:"all";a=l(a,b,!1);if("object"===
c(a))if("all"===f){var f=a.hub,h;for(h in f)f.hasOwnProperty(h)&&f[h].trigger(a.name,d)}else a.event.trigger(a.name,d);return e};this.off=function(a,d){var b="string"===c(d)?d:"all",f=l(a,d,!1),h,j;if(void 0!==f)if(h=a.split(":"),h=1===h.length?null:f.name,"all"===b)for(j in b=f.hub,b)b.hasOwnProperty(j)&&b[j].off(h);else f.event.off(h);else for(j in g)if(g.hasOwnProperty(j))for(h in g[j])g[j].hasOwnProperty(h)&&g[j][h].off();return e};this.close=function(a){var d="object"===c(a)?a:{};a="boolean"===
...
(a.history.splice(d,1),!0):!1;g()},setLocalStorage:function(d){a.localStorage="boolean"===typeof d?d:a.localStorage}};return e=new k.Object(c)},Api:function(b){var e,c={},a=q.typeOf,g=q.merge,h={protocol:"http://",timeout:1E4,async:!0},l={},s={},d=function(a,d,b,c){b.success=function(a){c.trigger("Success",a);e.trigger("Success",a)};b.error=function(a,b){var d={error:{id:2,description:b,response:a.response,xhr:a}},h="Error";if("timeout"===b||"Timeout"===b)h="Timeout";c.trigger(h,d);e.trigger(h,d)};
b.type=a;b.url=b.protocol+s.url+d.endpoint;a=$.ajax(b);c.request=a;return c},m=function(b,d,c){var f=null,j="Unknown";"string"===a(b)&&"object"===a(l[b])?(b="object"===a(l[b].options)?l[b].options:null,f=g(h,b),f=g(f,d)):("string"===a(b)&&(j=b),c.trigger("Error",{error:{id:1,description:"Request '"+j+"' doesn't exist."}}),e.trigger("Error",{error:{id:1,description:"Request '"+j+"' doesn't exist."}}));return f},f;for(f in b)if("requests"!==f&&"url"!==f)h[f]=b[f];else if("requests"===f){var n=b[f];
if("object"===a(n)){var j=void 0;for(j in n)if(n.hasOwnProperty(j)){var v=j,t=n[j];"string"===a(t.endpoint)&&(l[v]=t)}}else"string"===a(n)&&"string"===a(void 0)&&"string"===a((void 0).endpoint)&&(l[n]=void 0)}else"url"===f&&(s[f]=b[f]);c.post=function(a,b){var e=new k.Object,c=m(a,b,e);c&&d("POST",l[a],c,e);return e};c.get=function(a,b){var e=new k.Object,c=m(a,b,e);c&&d("GET",l[a],c,e);return e};return e=new k.Object(c)},Controller:function(b){var e=q.typeOf;b="object"===e(b)?b:{};var c="string"===
e(b.appname)?b.appname:null;c&&"object"===e(k.Apps[c])?b.app=k.Apps[c]:"object"===e(k._)&&"object"===e(k._.defapp)&&(b.app=k._.defapp);b=new k.Object(b);"function"===e(b.init)&&b.init(b);return b},Data:function(b){var e,c=q.typeOf,a=q.merge,g={},h=!1,l=function(b,h){var f="string"===c(g.request)?g.request:null,l="object"===c(g.app.Api)?g.app.Api:null,j="string"===c(g.pushkey)?g.pushkey:null,k,s,p="object"===c(h)?h:{},q="string"===c(p.method)?p.method:null,r="object"===c(p.data)?p.data:null,u;!q&&
"push"===b?(q="post",u="Push",k="boolean"===c(p.update)?p.update:!1,s="boolean"===c(p.merge)?p.merge:!1):!q&&"pull"===b&&(q="get",u="Pull",k="boolean"===c(p.update)?p.update:!0,s="boolean"===c(p.merge)?p.merge:!0);null===r&&(r="object"===c(e.attributes)?e.attributes:{});p.data=r;f&&l&&(f=l[q](f,p),f.on("Success",function(b,d){r=j&&"undefined"!==c(d[j])?d[j]:d;!0===s&&(r=a(r,e.attributes));!0===k&&e.set(r);e.trigger(u+":Success",r)}),f.on("Error",function(a,b){e.trigger(u+":Error",b)}),f.on("Timeout",
function(a,b){e.trigger(u+":Timeout",b)}));return e},s="string"===c(b.appname)?b.appname:null;b="object"===c(b)?b:{};g=a(b,{attributes:{}});s&&"object"===c(k.Apps[s])?g.app=k.Apps[s]:"object"===c(k._)&&"object"===c(k._.defapp)&&(g.app=k._.defapp);g.id&&g.attributes&&!h&&(h=new k.Cache({size:1,id:g.id,localStorage:!0}),h.get()[0]!=={}||""!==h.get()[0]?g.attributes=h.get()[0]:h.add(g.attributes));g.set=function(a,b){if("object"===typeof a)e.attributes=a,e.trigger("Change",{newdata:a});else if("string"===
typeof a)"object"!==c(e.attributes)&&(e.attributes={}),e.attributes[a]=b,e.trigger("Change:"+a,{newdata:b});else return!1;var f="string"===c(g.id)?g.id:null;f&&(h||(h=new k.Cache({size:1,id:f,localStorage:!0})),h.add(e.attributes));return e};g.get=function(a){var b=e.attributes;return"string"===typeof a?b[a]:b};g.pull=function(a){return l("pull",a)};g.push=function(a){return l("push",a)};e=new k.Object(g);"function"===c(e.init)&&e.init(e);return e},Microtemplate:function(b){var e=/\{{([^}]+)\}}/g,
c={render:function(b){b="object"===typeof b?b:{};b="object"===typeof b.variables?b.variables:void 0;b="object"===typeof b?b:"object"===typeof a.arg.variables?a.arg.variables:null;var g,k,d,m;g=a.template;var f=document.createElement(a.elType);if(b&&"string"===typeof g){k=g.match(e);if(null!==k)for(var n=d=k.length;n--;)d=k[n],m=k[n].slice(2,k[n].length-2),g=g.replace(d,b[m]);a.rendered=g;f.innerHTML=g;a.el=$(g);c.onDone()}else"string"===typeof g&&(a.rendered=g,f.innerHTML=g,a.el=$(g),c.onDone());
...
a={elType:"div",arg:b,url:void 0,template:void 0,rendered:void 0,version:0,render:c.render},g="boolean"===typeof b.force?b.force:!1;a.arg=b;"string"===typeof b.html?(a.template=b.html,"function"===typeof b.loaded&&b.loaded(a),c.render()):"string"===typeof b.url&&(a.url=b.url,c.getT(g));a.version="number"===typeof b.version?b.version:"object"===typeof k._&&"object"===typeof k._.defapp&&"object"===typeof k._.defapp.config&&"object"===typeof k._.defapp.config.versions&&"number"===typeof k._.defapp.config.versions.templates?
k._.defapp.config.versions.templates:1;return a},View:function(b){return new function(){var e=new k.Object,c={},a,g,h=q.isElement,l=function(b){var h,f="object"===typeof b?b:{},j="function"===typeof f.onSuccess?f.onSuccess:function(){},k=function(a){if(d){d.html(a);for(var b in c)c.hasOwnProperty(b)&&(m[b]=d.find(c[b]))}e.elements=m};if(!0===g)h=a.render(b),e.template=h,k(h.el),j(e),e.trigger("TemplateRendered",e);else e.on("TemplateReady",function(a,b){h=b;e.template=h;k(h.el);j(e);(void 0).trigger("TemplateRendered",
e)});return e},s=function(a,b){var c="string"===typeof a?a:null,d="string"===typeof b||"number"===typeof b?b:"",g,f=null,j;c&&(c=c.split(":"),g=c[0],"string"===typeof c[1]&&(f=c[1]),"undefined"!==typeof m[g]&&h(m[g][0])?j=m[g]:"string"===g&&(j=$(g)),null===f?j.html(d):j.attr(f,d));return e},d=null,m={},f=k,n=f.Apps,j="object"===typeof b?b:{},v="string"===typeof j.html?j.html:null,t="string"===typeof j.url?j.url:null,p="string"===typeof j.storageID?j.storageID:null,w="boolean"===typeof j.appstorage?
j.appstorage:!0,r="string"===typeof j.appname?j.appname:null;g=!1;!0===w&&p&&(!r&&"object"===typeof f._.defapp&&(r=f._.defapp.name),r&&("object"===typeof n&&"object"===typeof n[r])&&(f=n[r],f._.getTemplate(p,{url:t,html:v,loaded:function(b){a=b;g=!0;e.trigger("TemplateReady",a)}})));c="object"===typeof j.elements?j.elements:{};return function(a){a="object"===typeof a?a:{};d="object"===typeof a.el&&h(a.el[0])?a.el:"string"===typeof a.el?$(a.el):null;e.el=d;e.render=l;e.update=s;e.elements=m;e.events=
void 0;return e}}},App:function(b){var e=new k.Object,c=q,a=c.typeOf,g=k.Microtemplate,c=c.isElement,h={Router:{Default:""}},l={},s={},d=function(a,b,e){var c="object"===typeof l.Templates.get()[0]?l.Templates.get()[0]:!1,d=h.versions.templates;if(!c||"object"!==typeof c.templates)c={templates:{}},c.version=d;c.templates[a]={version:e,html:b};l.Templates.add(c)},m="object"===a(b)?b:{};b="string"===a(m.name)?m.name:Math.random().toString(36).substring(7);var c="object"===a(m.el)&&c(m.el[0])?m.el:$("body"),
f="boolean"===typeof m.localStorage?m.localStorage:!1,n="object"===typeof m.versions?m.versions:{},j=b+"_templates",v=b+"_data";n.templates="number"===typeof n.templates?n.templates:1;n.data="number"===typeof n.data?n.data:1;if(m)for(var t in m)m.hasOwnProperty(t)&&(h[t]=m[t]);h.versions=n;l.Templates=new k.Cache({size:1,id:j,localStorage:f});l.Data=new k.Cache({size:1,id:v,localStorage:f});k._.defapp=e;k.Apps[b]=e;t=h.Router;var m={},p,w={},r,u=/\{([^}]+)\}/g;if("object"===typeof t){for(var x in t)if(t.hasOwnProperty(x)){f=
x;j=f.split("/");""===j[0]&&j.splice(0,1);""===j[j.length-1]&&(j=j.splice(j.length-1,1));v=j.length;p=f.match(u);n=[];if(p)for(var y=r=0;y<v;y++)p=j[y].match(u)?j[y]:void 0,void 0!==p?(p=p.substr(1,p.length-2),n.push(p),w[p]=void 0,r++):n.push(void 0);m[x]={event:t[x],route:f,len:v,split:j,variables:n,varkeys:w}}s=m}e.el=c;e.name=b;e.start=function(){e.trigger("Starting");var b=function(a){var b=a.substr(1,a.length-1),c;if(""===a)c={key:"Default",variables:{}};else a:{a=s;var b=b.split("/"),d=!1,
...
d&&"false"!==e.attr("data-coreroute")&&(window.location=d)});return e};e.config=h;h.Api&&(e.Api=new k.Api(h.Api));"boolean"!==a(h.routerOverrideLinks)&&(h.routerOverrideLinks=!0);e._={saveTemplate:d,getTemplate:function(a,b){var c="object"===typeof b?b:{},e="object"===typeof l.Templates.get()[0]?l.Templates.get()[0]:!1,f=h.versions.templates,j="number"===typeof c.version?c.version:1,k="function"===typeof b.loaded?b.loaded:!1,c=!0;if(e)if("number"===typeof e.version&&e.version===f){if("object"===typeof e.templates&&
...
c=$(b),d=/(https?:\/\/[^\s]+)/g,f="";if("a"===b.nodeName||"A"===b.nodeName)f=c.attr("href"),f.match(d)?1===f.match(d).length&&(window.location=f):(a.preventDefault(),e.trigger("a:click",{el:c,url:f}))});return e},version:"0.2.6d"};"function"===typeof define&&define.amd?define("Core",[],function(){return k}):"undefined"!==typeof module&&"undefined"!==typeof exports&&module.exports?module.exports=k:A["string"===typeof z?z:"Core"]=k})(this,"$$");
