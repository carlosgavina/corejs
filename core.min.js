/* core.js v0.3.2 by @carlosgavina | hello@carlosgavina.com | https://github.com/carlosgavina/corejs */
...
j.template:null;h.render=n;h.gatherElements=r;e=new l.Object(h);"function"===c(e.init)&&e.init(e);e.on("Render",function(a,b){n(b)});return e},App:function(a){var b=new l.Object,c=q,d=c.typeOf,e=c.isElement,c={Router:{Default:""}},h,j={},r,n=function(a,c){var e,f="boolean"===d(c)?c:!1,g=e;e=a.substr(1,a.length-1);!1===f&&(g=e);!0===b.config.pushState?r!==e&&(r=e,!0===f?(g=window.location.href.replace(location.protocol+"//"+b.url,""),e=p(g)):(e=p(e),window.history.pushState(e.variables,b.name,g)),
b.trigger("Router:BeforeRouter"),b.trigger("Router:"+e.key,e.variables)):(e=p(e),b.trigger("Router:BeforeRouter"),b.trigger("Router:"+e.key,e.variables))},p=function(a){var b=j;a=a.split("/");var c=!1,d={},e;""===a[0]&&a.splice(0,1);""===a[a.length-1]&&(a=a.splice(0,a.length-1));e=a.length;for(var g in b)if(b.hasOwnProperty(g)&&e===b[g].len){for(var c=!0,f=0;f<e;f++)a[f].toLowerCase()!==b[g].split[f].toLowerCase()&&(c=!1);if(!1===c){for(f=0;f<e;f++)a[f].toLowerCase()===b[g].split[f].toLowerCase()&&
void 0===b[g].variables[f]?c=!0:a[f].toLowerCase()!==b[g].split[f].toLowerCase()&&void 0!==b[g].variables[f]?(c=!0,d[b[g].variables[f]]=a[f]):c=!1;return!0===c?{key:b[g].event,variables:d}:{key:"Default",variables:void 0}}}return{key:"Default",variables:void 0}},f="object"===d(a)?a:{};a="string"===d(f.name)?f.name:Math.random().toString(36).substring(7);var e="object"===d(f.el)&&e(f.el[0])?f.el:$("body"),m="boolean"===typeof f.localStorage?f.localStorage:!0,g="object"===typeof f.versions?f.versions:
{},k=a+"_templates",v=a+"_data";g.templates="number"===typeof g.templates?g.templates:1;g.data="number"===typeof g.data?g.data:1;if(f)for(var u in f)f.hasOwnProperty(u)&&(c[u]=f[u]);c.versions=g;h=new l.Cache({size:1,id:k,localStorage:m});new l.Cache({size:1,id:v,localStorage:m});l._.defapp=b;l.Apps[a]=b;u=c.Router;var f={},s,w={},A,B=/\{([^}]+)\}/g;if("object"===typeof u){for(var y in u)if(u.hasOwnProperty(y)){m=y;k=m.split("/");""===k[0]&&k.splice(0,1);""===k[k.length-1]&&(k=k.splice(k.length-1,
1));v=k.length;s=m.match(B);g=[];if(s)for(var z=A=0;z<v;z++)s=k[z].match(B)?k[z]:void 0,void 0!==s?(s=s.substr(1,s.length-2),g.push(s),w[s]=void 0,A++):g.push(void 0);f[y]={event:u[y],route:m,len:v,split:k,variables:g,varkeys:w}}j=f}b.el=e;b.name=a;b.start=function(){b.trigger("Starting");if(!0===b.config.pushState)window.onpopstate=function(){n(window.location.href,!0)},n(window.location.href,!0);else{if("onhashchange"in window)window.onhashchange=function(){n(window.location.hash)};else{var a=window.location.hash,
c;window.setInterval(function(){window.location.hash!=a&&(c=window.location.hash,n(c))},100)}n(window.location.hash)}b.trigger("Started");b.on("a:click",function(a,c){var e;e=c.url;e="string"===d(e)?e:null;var f="";e?("#"!==e.charAt(0)&&"/"!==e.charAt(0)?f="#/"+e:"/"===e.charAt(0)?f="#"+e:"#"===e.charAt(0)&&"/"!==e.charAt(1)?(f=e.substring(e.length,2),f="#/"+f):f=e,e=f):e=null;f=c.el;e&&"false"!==f.attr("data-coreroute")&&(!0===b.config.pushState?n(e):window.location=e)});return b};b.config=c;b.url=
"string"===d(c.url)?c.url:window.location.host;b.config.pushState="boolean"===d(c.pushState)?c.pushState:window.history.pushState?!0:!1;c.Api&&(b.Api=new l.Api(c.Api));"boolean"!==d(c.routerOverrideLinks)&&(c.routerOverrideLinks=!0);b._={saveTemplate:function(a,b){var c=h.get()[0];"object"!==d(c)&&(c={});c[a]=b;h.add(c)},getTemplate:function(a){var b=h.get()[0];if("object"===d(b))return b[a]}};if(!0===c.routerOverrideLinks)e.on("click",function(a){var c=a.target,d=$(c),e=/(https?:\/\/[^\s]+)/g,f=
"";if("a"===c.nodeName||"A"===c.nodeName)f=d.attr("href"),f.match(e)?1===f.match(e).length&&(window.location=f):(a.preventDefault(),b.trigger("a:click",{el:d,url:f}))});"function"===d(b.init)&&b.init(b);$(document).ready(function(){b.trigger("Ready")});return b},version:"0.3.2"};l.View.extend=function(a){var b={};b.config=a;b.config.extended=!0;return l.View.bind(b)};l.Data.extend=function(a){var b={};b.config=a;b.config.extended=!0;return l.Data.bind(b)};l.Controller.extend=function(a){var b={};
b.config=a;b.config.extended=!0;return l.Controller.bind(b)};"function"===typeof define&&define.amd?define("Core",[],function(){return l}):"undefined"!==typeof module&&"undefined"!==typeof exports&&module.exports?module.exports=l:C["string"===typeof w?w:"Core"]=l})(this,"$$");
