/* core.js v0.3.3b by @carlosgavina | hello@carlosgavina.com | https://github.com/carlosgavina/corejs */
...
a.key,a.variables)}}else a=h(g),b.trigger("Router:BeforeRouter"),b.trigger("Router:"+a.key,a.variables)},h=function(a){var b=k;a=a.split("/");var c=!1,d={},e,f,g=[];""===a[0]&&a.splice(0,1);""===a[a.length-1]&&(a=a.splice(0,a.length-1));e=a.length;for(var h in b)if(b.hasOwnProperty(h)){if(e===b[h].len){c=!0;f=h;for(var j=0;j<e;j++)if(a[j].toLowerCase()!==b[h].split[j].toLowerCase())c=!1;else{c=!0;break}if(!1===c)for(j=0;j<e;j++)if(a[j].toLowerCase()===b[h].split[j].toLowerCase()&&void 0===b[h].variables[j]?
(g.push(!0),f=h):void 0!==b[h].variables[j]&&(g.push(!0),d[b[h].variables[j]]=a[j]),g.length===e)return{key:b[f].event,variables:d}}if(!0===c)break}return!0===c?{key:b[f].event,variables:d}:{key:"Default",variables:void 0}},l=function(a){a="string"===d(a)?a:null;var b="";return a?("#"!==a.charAt(0)&&"/"!==a.charAt(0)?b="#/"+a:"/"===a.charAt(0)?b="#"+a:"#"===a.charAt(0)&&"/"!==a.charAt(1)?(b=a.substring(a.length,2),b="#/"+b):b=a,b):null},g="object"===d(a)?a:{};a="string"===d(g.name)?g.name:Math.random().toString(36).substring(7);
...
typeof v){for(var y in v)if(v.hasOwnProperty(y)){q=y;t=q.split("/");""===t[0]&&t.shift();""===t[t.length-1]&&t.pop();x=t.length;u=q.match(B);r=[];if(u)for(var z=A=0;z<x;z++)u=t[z].match(B)?t[z]:void 0,void 0!==u?(u=u.substr(1,u.length-2),r.push(u),w[u]=void 0,A++):r.push(void 0);g[y]={event:v[y],route:q,len:x,split:t,variables:r,varkeys:w}}k=g}b.go=function(a){n(l(a))};b.el=e;b.name=a;b.start=function(){b.trigger("Starting");if(!0===b.config.pushState)window.onpopstate=function(){!1===p&&n(window.location.href,
!0,p);p=!1},n(window.location.hash,!0,p);else{if("onhashchange"in window)window.onhashchange=function(){n(window.location.hash)};else{var a=window.location.hash,c;window.setInterval(function(){window.location.hash!=a&&(c=window.location.hash,n(c))},100)}n(window.location.hash)}b.trigger("Started");b.on("a:click",function(a,c){var d=l(c.url),e=c.el;d&&"false"!==e.attr("data-coreroute")&&(!0===b.config.pushState?n(d):window.location=d)});return b};b.config=c;b.url="string"===d(c.url)?c.url:window.location.host;
b.config.pushState="boolean"===d(c.pushState)?c.pushState:window.history.pushState?!0:!1;c.Api&&(b.Api=new j.Api(c.Api));"boolean"!==d(c.routerOverrideLinks)&&(c.routerOverrideLinks=!0);b._={saveTemplate:function(a,b){var c=f.get()[0];"object"!==d(c)&&(c={});c[a]=b;f.add(c)},getTemplate:function(a){var b=f.get()[0];if("object"===d(b))return b[a]}};if(!0===c.routerOverrideLinks)e.on("click",function(a){var c=a.target,d=$(c),e=/(https?:\/\/[^\s]+)/g,f="";if("a"===c.nodeName||"A"===c.nodeName)f=d.attr("href"),
f.match(e)?1===f.match(e).length&&(window.location=f):(a.preventDefault(),b.trigger("a:click",{el:d,url:f}))});"function"===d(b.init)&&b.init(b);$(document).ready(function(){b.trigger("Ready")});return b},version:"0.3.3b"};j.View.extend=function(a){var b={};b.config=a;b.config.extended=!0;return j.View.bind(b)};j.Data.extend=function(a){var b={};b.config=a;b.config.extended=!0;return j.Data.bind(b)};j.Controller.extend=function(a){var b={};b.config=a;b.config.extended=!0;return j.Controller.bind(b)};
"function"===typeof define&&define.amd?define("Core",[],function(){return j}):"undefined"!==typeof module&&"undefined"!==typeof exports&&module.exports?module.exports=j:C["string"===typeof w?w:"Core"]=j})(this,"$$");
